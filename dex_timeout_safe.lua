...
local EmbeddedModules = {
    ...
    if i % 250 == 0 then task.wait() end
				    if i % 250 == 0 then task.wait() end
					local obj = insts[i]
					if nodes[obj] then end -- Deferred
    ...
    if i % 250 == 0 then task.wait() end
						...
						if (isSearching and not searchResults[n]) or n.Del then end
    ...
    if i % 250 == 0 then task.wait() end
				...
				local mouse = Main.Mouse or service.Players:FindFirstChild(Namex):GetMouse()
				local function move()
    ...
    if i % 250 == 0 then task.wait() end if v.Obj and v.Obj:IsA("TouchTransmitter") then firetouchinterest(hrp, v.Obj.Parent, 0) end end
				end})
				...
				context:Register("FIRE_CLICKDETECTOR",{Name = "Fire ClickDetector", IconMap = Explorer.ClassIcons, Icon = 41, OnClick = function()
					...
					if not hrp then return end
					for _, v in ipairs(selection.List) do
    if i % 250 == 0 then task.wait() end if v.Obj and v.Obj:IsA("ClickDetector") then fireclickdetector(v.Obj) end end
				end})
				...
				context:Register("FIRE_PROXIMITYPROMPT",{Name = "Fire ProximityPrompt", IconMap = Explorer.ClassIcons, Icon = 124, OnClick = function()
					...
					if not hrp then return end
					for _, v in ipairs(selection.List) do
    if i % 250 == 0 then task.wait() end if v.Obj and v.Obj:IsA("ProximityPrompt") then fireproximityprompt(v.Obj) end end
				end})
			...
			Explorer.DefaultProps = {
				["BasePart"] = {
					Position = function(Obj)
						local Player = service.Players:FindFirstChild(Namex)
    ...
    if i % 250 == 0 then task.wait() end
			...
			Explorer.DoSearch = function(query)
				...
				local function searchTable(root, str, func)
					...
					for idx,node in ipairs(root) do
    if i % 250 == 0 then task.wait() end
    ...
    if i % 250 == 0 then task.wait() end
						...
						if processed and not refreshDebounce then end
						fw(0.5)
					end
				end)()
			end
    ...
    if i % 250 == 0 then task.wait() end v:Disconnect() end
    ...
    if i % 250 == 0 then task.wait() end oldHeight = oldHeight + v.SizeY end
					for i,v in pairs(windows) do
    if i % 250 == 0 then task.wait() end
						if i == #windows then
    ...
    if i % 250 == 0 then task.wait() end if v == self then table.remove(leftSide.Windows,i) break end end
						for i,v in pairs(rightSide.Windows) do
    if i % 250 == 0 then task.wait() end if v == self then table.remove(rightSide.Windows,i) break end end
    ...
    if i % 250 == 0 then task.wait() end if v == self then table.remove(visibleWindows,i) break end end
				...
				funcs.AlignTo = function(self,side,pos,size,silent)
					...
					if size > 0 and size <= 1 then
						...
						for i,v in pairs(side.Windows) do
    if i % 250 == 0 then task.wait() end totalSideHeight = totalSideHeight + v.SizeY end
					...
					for i,v in pairs(side.Windows) do
    if i % 250 == 0 then task.wait() end v.Gui.DisplayOrder = sideDisplayOrder end
    ...
    if i % 250 == 0 then task.wait() end
				...
				local mt = {__index = funcs}
				local function new()
					if not mouse then mouse = Main.Mouse or service.Players:FindFirstChild(Namex):GetMouse() end
    ...
    if i % 250 == 0 then task.wait() end
						if col <= lastEnding then highlights[col] = currentType end
    ...
    if i % 250 == 0 then task.wait() end
			...
			Lib.BrickColorPicker = (function()
				...
				local mouse = service.Players:FindFirstChild(Namex):GetMouse()
				local hexStartX = 4
				local hexSizeX = 27
    ...
    if i % 250 == 0 then task.wait() end
					...
					local function loadSequence(self,seq)
						resetSequence = seq
						for i,v in pairs(points) do
    if i % 250 == 0 then task.wait() end if v[4] then v[4]:Destroy() end end
						points = {}
    ...
    if i % 250 == 0 then task.wait() end
					...
					local function loadSequence(self,seq)
						resetSequence = seq
						for i,v in pairs(colors) do
    if i % 250 == 0 then task.wait() end if v[3] then v[3]:Destroy() end end
						colors = {}
						currentlySelected = nil
						for i,v in pairs(seq.Keypoints) do
    if i % 250 == 0 then task.wait() end
...
local plr = service.Players:FindFirstChild(Namex) or service.Players.PlayerAdded:wait()

local create = function(data)
	local insts = {}
	for i,v in pairs(data) do
    if i % 250 == 0 then task.wait() end insts[v[1]] = Instance.new(v[2]) end
...
Main = (function()
    ...
    if i % 250 == 0 then task.wait() end newClass.Tags[tag] = true end end
    ...
    if i % 250 == 0 then task.wait() end newMember.Tags[tag] = true end end
    ...
    if i % 250 == 0 then task.wait() end newEnum.Tags[tag] = true end end
